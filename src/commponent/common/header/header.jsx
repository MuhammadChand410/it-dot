...
//     return (
//         <header className="bg-white py-[22px] sticky top-0 left-0 z-50 shadow-xs">
...
//                                         <svg
//                                             className={`ml-1 w-5 h-5 transition-transform duration-200 ${openDropdown ? "rotate-180" : "rotate-0"
//                                                 }`}
//                                             fill="none"
//                                             stroke="currentColor"
//                                             strokeWidth="2"
...
//                                         <span
//                                             className={`absolute -top-2 -left-2 -translate-x-1/2 w-2 h-2 rounded-full bg-[#0160C9]
//                                                         transition-opacity duration-200 ${openDropdown ? "opacity-100" : "opacity-0"}`}
//                                         ></span>

//                                         <div
//                                             className={`absolute top-8 left-0 bg-white shadow-xl rounded-xl py-4 px-4 w-48
//                                                         transition-all duration-200 origin-top ${openDropdown ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"
//                                                 }`}
//                                         >
...
//                         ))}
//                     </ul>
//                     <button className="bg-[#0160C9] cursor-pointer py-2.5 px-5 rounded-full text-white text-sm font-semibold hover:bg-[#014fa8] transition-all duration-200">
//                         Get Started
//                     </button>
//                 </nav>
//             </div>
...
export default function Header() {
    ...
    const RESOURCES_MENU = [
        ...
        { id: 3, text: "Documentation", path: "/docs" },
        { id: 4, text: "Guides", path: "/guides" },
    ];

    const HEADER_LINKS = [
        { id: 1, text: "Home", path: "/" },
        { id: 2, text: "Product", path: "/product" },
        { id: 3, text: "Why dot.it", path: "/why" },
