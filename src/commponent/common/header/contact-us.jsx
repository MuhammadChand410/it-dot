...
export default function ComponentContactUs({ heading, description }) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-[minmax(100px,698px)_minmax(100px,582px)] gap-8 md:gap-12 items-center">
                    <div className="w-full pl-0 md:pl-10 md:order-1 order-2">
                        <div className="pb-6 md:pb-8">
                            <h2 className="text-3xl font-semibold text-[#141219] pb-2">{heading}</h2>
                            <p className="text-base font-normal text-[#777B8B]">{description}</p>
                        </div>
                        <Formik
                        ...
                        >
                            {() => (
                                <Form className="space-y-6">
                                    ...
                                    <button type="submint" className={`bg-[#0160C9] shadow-xl flex w-fit cursor-pointer py-2 items-center gap-3 px-4 rounded-full text-white text-base font-semibold hover:bg-[#014fa8] transition-all duration-200`}>
                                        Send Message
                                        <ArrowIcon />
                                    </button>
                                </Form>
