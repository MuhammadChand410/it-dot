            ...
            <div className="">
                ...
                <div className="bg-white py-8">
                    <div className="container">
                        <div className="grid grid-cols-1 md:[grid-template-columns:minmax(100px,281px)_minmax(100px,632px)] justify-between">
                            <div className="">
                                <Link to={`/`}>
                                ...
                                <LinkdenIcon />
                                <p className="mt-8 pb-2 text-base text-[#A3A3A3] font-normal">dot.it | © 2025</p>
                            </div>
                            <div>
