...
//   infinite: true,
//   speed: 500,
//   slidesToShow: 2,        // Desktop par 2 cards
//   slidesToScroll: 1,      // Pura card slide hoga
//   responsive: [
//     {
//       breakpoint: 1024,
//       settings: {
...
//                             <div
//                                 key={card.id}
//                                 className="w-full md:w-1/3 flex-shrink-0 bg-[#F5F5F5] p-6 rounded-3xl grid gap-4"

//                                 // className="min-w-[100%] md:min-w-[31.7%] bg-[#F5F5F5] p-6 rounded-3xl grid gap-4"
//                             >
//                                 <SliderIcon />
...
//                                         <h2 className="text-base font-bold text-[#67646A]">
//                                             {card.title}
//                                         </h2>
...
//                     <button
//                         onClick={prevSlide}
//                         disabled={index === 0} className="cursor-pointer">
//                         <LeftIcon />
//                     </button>
//                     <button
//                         onClick={nextSlide}
//                         disabled={index >= total - visible} className="cursor-pointer">
//                         <RightIcon />
//                     </button>
//                 </div>
//             </div>
                    ...
                    >
                        {SLIDER_TEAMS.map(card => (
                            <div
                                ...
                                className="flex-shrink-0 bg-[#F5F5F5] p-6 rounded-3xl grid gap-4"
                            >
                                <SliderIcon />
                                <p className="text-xl text-[#141219]">{card.desc}</p>
