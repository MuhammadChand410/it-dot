...
// import { CrmImage } from "../../assets/images";
...
//                     <HeadDesc heading={`Maximize the value of your CRM`} classNamehead={`!pb-4`} desc={`Works seamlessly with your current tools`} classNameDesc={`!text-center !pb-15`} />
//                 </div>
//                 <div className="grid grid-cols-1 items-center  md:[grid-template-columns:minmax(100px,482px)_minmax(100px,751px)] gap-11">
//                     <div className="grid gap-6">
//                         {VALUE_CRM.map((card =>
//                             <Link className="py-3 px-6 bg-[#E9EAEB] hover:bg-[#D9E7F7] rounded-3xl" key={card.id}>
...
//                     </div>
//                     <div>
//                         <img src={CrmImage} alt="crm-image" width={767} height={520} loading="lazy" />
//                     </div>
//                 </div>
//             </div>
//         </section>
