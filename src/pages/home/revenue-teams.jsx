...
import { CrmFive, CrmFour, RevanueTeam, ThatWorksImage } from "../../assets/images";
...
export default function RevenueTeams() {
    ...
    const WORKS_BUTTON = [
        { id: 1, text: 'Revenue Teams' },
        { id: 2, text: 'Customer Success' },
        ...
        <section className="py-8 md:py-20 bg-[#E6EFFA]">
            <div className="container">
                ...
                <div className="grid justify-center pb-10 md:pb-15">
                    <div className="bg-[#F9FAFB] shadow-xs px-2 py-2 rounded-4xl max-w-[500px] md:max-w-[716px] flex justify-between">
                        {WORKS_BUTTON.map((card) => (
                            <button
                                key={card.id}
                                onClick={() => setActiveTab(card.id)}
                                className={`text-base cursor-pointer font-semibold px-6 py-2 rounded-4xl transition-all
                                    ${activeTab === card.id
                ...
                <div className="grid grid-cols-1 items-center 
                    ...
                    <div className="max-w-[496px]">
                        <h3 className="text-4xl font-semibold text-[#141219] pb-6">
                            {CONTENT[activeTab].title}
                        </h3>
                        <p className="text-2xl leading-8 font-normal text-[#141219] pb-6">
