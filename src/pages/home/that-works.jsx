...
import { ThatWorksImage } from "../../assets/images";
        ...
        <section className="py-8 md:py-20">
            <div className="container">
                ...
                <div className="grid justify-center pb-10 md:pb-15">
                    ...
                    <div className="bg-[#F9FAFB] shadow-xs px-2 py-2 rounded-4xl max-w-[616px] flex justify-between">
                        ...
                        <div className="grid pb-6 gap-4">
                            {CONTENT[activeTab].points.map((text, index) => (
                                <div className="flex items-start gap-2" key={index}>
                                    <TickIcon />
                                    <p className="text-lg font-normal text-[#141219]">{text}</p>
                                </div>
                            ))}
                        </div>
                        <Button/>
